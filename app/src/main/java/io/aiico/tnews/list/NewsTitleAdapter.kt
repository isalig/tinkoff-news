...
import io.aiico.tnews.inflateViewHolder

class NewsTitleAdapter(inline val onClick: (id: String) -> Unit) : RecyclerView.Adapter<NewsTitleViewHolder>() {

    private val titles = ArrayList<NewsTitle>()

    fun submitList(newNewsTitles: List<NewsTitle>) {
        titles.clear()
